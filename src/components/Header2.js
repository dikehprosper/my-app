        ...
        <header style={{ height: "100px", backgroundColor: "#373a45", boxShadow: "0 2px 2px rgba(0, 0, 0, 0.2)", padding: "0 30px", display: "flex", alignItems: "center", justifyContent: "space-between", fontSize: "10px", zIndex: "500" }}>
            ...
            <div className="links">
                ...
                <NavLink to="/Register" className={activeLink === "" ? "active" : ""}
                    onClick={() => handleClick("")} style={{ fontSize: "12px", fontWeight: "500", marginRight: "11px" }}>Make a Deposit</NavLink>

                <button className="button4" onClick={handleClick1} style={{ display: "flex", gap: "50px", justifyContent: "center", alignItems: "center" }}> 
                <span style={{ display: "flex", justifyContent: "center", alignItems: "center", fontWeight: "500", fontSize: "12px" }}> 
                <CgProfile style={{ fontSize: "23px", color: "white", }} /> 
                &nbsp; My Account
                  </span> 
                  <span style={{ display: "flex", justifyContent: "center", alignItems: "center", fontWeight: "500", fontSize: "12px" }}>
                    20.00     
                    <IoMdArrowDropdown style={{ fontSize: "14px", color: "white", }} />
                   </span>
                </button>
                </div>
                    ...
                    <div className="profile">
                        <div className="profile3">
                            ...
                            <div className="profile13">
                                <FaEye style={{ fontSize: "17px", fontWeight: "600" }} /> &nbsp; <TbReload style={{ fontSize: "16px", fontWeight: "600" }} />
                            </div>
                        </div>
                        <div className="profile3">
                            <div className="profile8">
                                ...
                                <div style={{ display: "flex", justifyContent: "start", alignItems: "center", fontWeight: "500", fontSize: "12px" }}>
                                    <img src={logo51} alt="logo51" style={{height:"13px"}} /> 20.00
                                </div>
                            </div>
             ...
             <div className="profile1">Sport Bonus</div>
              <div className="profile1">Bonus Casino</div>
               <div className="profile1">Bet9ja Rewards</div>
                <div className="profile14">Logout</div>
                        </div> </div> : null}
